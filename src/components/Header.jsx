...
import curriculo from '../files/samuel_curriculo.pdf';
...
export default function Header() {
	return (
		<header className="header">
			<nav className="communication">
				<Link to="/">
					<img src={fotoPerfil} alt="Foto de perfil" className="samuel-image" />
				</Link>

				<a href="mailto:pro_samuel@outlook.com">
					<img src={emailLogo} alt="Icone de email" />
